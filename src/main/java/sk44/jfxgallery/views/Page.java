...
public class Page {
	...
	public void turnPage(final Page toPage) {
		...
		imageViewPane.openPage(nextImageView, new PageTurnableImageViewPane.TurnPageCallback() {
			@Override
			public void execute() {
				if (forward) {
				...
				toPage.imageViewPane.closePage(toImageView, new PageTurnableImageViewPane.TurnPageCallback() {
					@Override
					public void execute() {
